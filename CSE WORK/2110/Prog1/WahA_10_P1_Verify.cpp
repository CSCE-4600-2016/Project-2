...
//	WahA_10_P1_Verify.cpp   **** MODIFY WITH YOUR FILENAME  ****
...
{ //***main
  ...
  int log_complete = 0;
  char f_name[30] = "Asad";  //** change xxxFNAMExxx to your first name
  char l_name[30] = "Waheed";  //** change xxxLNAMExxx to your last name
